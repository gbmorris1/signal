...
const styles = StyleSheet.create({
  ...
  step: { ...typography.ticker, fontSize: 9, color: colors.accent },
  title: { ...typography.display, fontSize: 27, color: colors.text, marginTop: spacing.md },
  sub: { ...typography.prose, fontSize: 14, color: colors.textMuted, marginTop: spacing.sm },
  ...
  pillText: { ...typography.heading, fontSize: 14, color: colors.textMuted },
  ...
  levelHint: { ...typography.caption, color: colors.textFaint, marginTop: 3 },
  ...
  backText: { ...typography.ticker, fontSize: 9, color: colors.textMuted },
});
